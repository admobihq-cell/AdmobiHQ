...
The actor-by-actor build plan for turning the current scaffolds into the working product. Product story and brand: [PRODUCT.md](../PRODUCT.md) · How the repo is laid out: [ARCHITECTURE.md](./ARCHITECTURE.md) · API reference: [API.md](./API.md).
