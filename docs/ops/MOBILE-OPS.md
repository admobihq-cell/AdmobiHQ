...
Download the APK from the EAS dashboard when the build completes. See [MOBILE-BUILDS.md](../shared/MOBILE-BUILDS.md) for OTA updates, keystores, and customer app builds.
