...
For a full command list (Infisical, Prisma, Payload, seeds, troubleshooting), see **[DEV-SETUP.md](../shared/DEV-SETUP.md)**.
...
See [DATA-LAYER.md](../shared/DATA-LAYER.md) for the full split (Prisma = main backend, Payload = CMS only).
...
- **Prisma vs Payload (read first):** [DATA-LAYER.md](../shared/DATA-LAYER.md)
- Architecture: [ARCHITECTURE.md](../shared/ARCHITECTURE.md) § Help CMS
