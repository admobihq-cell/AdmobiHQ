...
const SPEED_NEON_IMAGE = require("@/assets/images/speed-neon-lights-city.jpg")
const TAXI_STREET_IMAGE = require("@/assets/images/taxi-street-night.jpg")

const SLIDES: Slide[] = [
  {
    key: "overview",
    eyebrow: "Your ops dashboard",
    title: "Everything, one glance away",
    body: "Leads, fleet status, and driver activity — all live in one place.",
    image: AERIAL_ROUTES_IMAGE,
  },
  {
    key: "pipeline",
    eyebrow: "Leads & waitlist",
    title: "Turn interest into campaigns",
    body: "Track every inbound lead and waitlist signup from first contact to signed campaign.",
    image: SPEED_NEON_IMAGE,
  },
  {
    key: "fleet",
    eyebrow: "Fleet & drivers",
    title: "Keep the fleet moving",
    body: "Manage units, assign drivers, and stay on top of installs across the city.",
