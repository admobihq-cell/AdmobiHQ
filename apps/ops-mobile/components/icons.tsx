...
export const Check = ionicon("checkmark")
...
export const UserCircle = ionicon("person-circle-outline")
export const X = ionicon("close-outline")
export const Menu = ionicon("menu-outline")
export const ImageIcon = ionicon("image-outline")
export const Rocket = ionicon("rocket-outline")
export const Users = ionicon("people-outline")
export const ClipboardList = ionicon("clipboard-outline")
export const Newspaper = ionicon("newspaper-outline")
