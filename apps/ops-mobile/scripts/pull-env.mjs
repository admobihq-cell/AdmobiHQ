...
try {
  ...
  console.log("[ops-mobile env:pull] Pulled from Infisical")
} catch {
  ...
  if (existsSync(fallbackPath)) {
    ...
    console.log(
      `[ops-mobile env:pull] Infisical unavailable — mapped from ${fallbackPath}`,
    )
  } else {
    console.error("[ops-mobile env:pull] Failed to pull from Infisical.")
...
if (additions) {
  ...
  console.log("[ops-mobile env:pull] Mapped NEXT_PUBLIC_* → EXPO_PUBLIC_*")
}
