...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_blog_posts_topic" AS ENUM('ooh', 'campaigns', 'product', 'company', 'insights');
  CREATE TYPE "public"."enum_blog_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__blog_posts_v_version_topic" AS ENUM('ooh', 'campaigns', 'product', 'company', 'insights');
  ...
  CREATE TABLE "blog_posts" (
  	...
  	"topic" "enum_blog_posts_topic" DEFAULT 'insights',
  	"body" jsonb,
  ...
  CREATE TABLE "_blog_posts_v" (
  	...
  	"version_topic" "enum__blog_posts_v_version_topic" DEFAULT 'insights',
  	"version_body" jsonb,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_blog_posts_topic";
  DROP TYPE "public"."enum_blog_posts_status";
  DROP TYPE "public"."enum__blog_posts_v_version_topic";
