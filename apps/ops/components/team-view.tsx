...
export function TeamView() {
  ...
  async function handleRoleChange(member: TeamMemberDto, input: TeamRoleUpdateInput) {
      ...
      <AlertDialog open={removeTarget !== null} onOpenChange={() => setRemoveTarget(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              They&apos;ll immediately lose access to the ops console. You can re-invite them
              later.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
