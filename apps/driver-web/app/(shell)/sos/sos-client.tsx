  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-6">
          ...
          {TYPES.map(({ value, label, icon: Icon }) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex aspect-square flex-col items-center justify-center gap-1.5 rounded-xl border p-2 text-center transition",
      ...
      <div className="flex flex-col gap-2">
        ...
        {/* Native capture — no dropzone dependency. `capture` opens the rear
            camera directly on a phone browser. */}
        <input
          ref={fileInput}
          type="file"
          accept="image/*"
      ...
      <Button
        ...
        onClick={() => void submit()}
      >
        {submitting ? <Loader2 className="size-4 animate-spin" /> : <Siren className="size-4" />}
