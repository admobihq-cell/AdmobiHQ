 ...
 * Revalidates every 5 minutes via Next's fetch cache, so a toggle in ops
 * still propagates without a deploy — see docs/driver/DRIVER-APP.md for the
 * full flag design. A 60s revalidate was waking Neon on every layout render.
 */
