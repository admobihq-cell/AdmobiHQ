...
export const Camera = ionicon("camera-outline")
...
export const CarCrash = ionicon("car-sport-outline")
export const Medical = ionicon("medkit-outline")
export const Theft = ionicon("lock-open-outline")
export const Harassment = ionicon("hand-left-outline")
export const Breakdown = ionicon("build-outline")
export const Damage = ionicon("hammer-outline")
export const HelpBuoy = ionicon("help-buoy-outline")
export const Trash = ionicon("trash-outline")
export const Images = ionicon("images-outline")
