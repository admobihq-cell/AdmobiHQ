...
const DRIVER_TAXI_IMAGE = require("@/assets/images/driver-taxi-night.jpg")
const DRIVER_PHONE_MOUNT_IMAGE = require("@/assets/images/driver-phone-mount.jpg")
const DRIVER_AERIAL_ROUTES_IMAGE = require("@/assets/images/driver-aerial-routes.jpg")

const SLIDES: Slide[] = [
  {
    key: "drive",
    eyebrow: "Drive your route",
    title: "Turn your commute into income",
    body: "Mount a screen, drive the streets you already know, and earn for every mile on the road.",
    image: DRIVER_TAXI_IMAGE,
  },
  {
    key: "track",
    eyebrow: "Live tracking",
    title: "Watch your earnings add up",
    body: "See screen-on hours, distance, and impressions update as you drive — no guessing what you're owed.",
    image: DRIVER_PHONE_MOUNT_IMAGE,
  },
  {
    key: "payouts",
    eyebrow: "Get paid",
    title: "Payouts, sorted",
    body: "Track pending and settled payouts in one place as your earnings history builds route by route.",
    image: DRIVER_AERIAL_ROUTES_IMAGE,
  },
]
