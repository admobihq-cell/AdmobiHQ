...
import { SUPPORT_CATEGORIES } from "@/components/support/support-ui"
...
export default function NewSupportRequestScreen() {
  ...
  useEffect(() => {
    // Hydrating from AsyncStorage — an external system — is exactly what this
    // effect is for; it can only run once, on mount.
  ...
  const styles = useThemedStyles((c) => ({
    ...
    errorText: { ...typography.bodySm, color: c.danger },
    submit: {
      alignItems: "center" as const,
    ...
    <>
      ...
      >
        <Text style={styles.introBody}>
          We&apos;ll email you at the address below when the team replies, and the thread stays
          here in the app.
        </Text>
